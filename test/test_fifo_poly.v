...
Module fifo1. Section fifo1.
  ...
  Proof.
    cbn -[bv_unsigned]. (* reduces [#st..valid] in [length] even though [t] is abstract. *)
    (* embed_bool (Zmod.eqb 0 (valid st)) <> valid st *) destruct (BV.bool_cases (valid st)); intro Heq; apply bv_eq in Heq; vm_compute in Heq; discriminate.
  Qed.
End fifo1. End fifo1.
